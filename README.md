...
The "Multirisk app" considers input data from multiparametric analysis and is best suited when measured values, with its uncertainty values, specification limits and correlation coefficients (if applicable) are known. However, it can also be used when there is no prior knowledge of correlation effects, but this can impact the results provided by the tool.
For further information about how to use it, please refer to doi.org/10.1016/j.microc.2026.117824.

You can contact us at labmeq@usp.br if any other question. 
